...
function initContactForm() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
      ...
      submitBtn.innerHTML = `
        <span>Sending...</span>
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="animation: spin 1s linear infinite;">
      ...
      const formUrl = "https://docs.google.com/forms/u/0/d/e/1FAIpQLScusZdjbQX5lwjufTjlqQE4Vx-MBCkzUaLoH2Nm-anIdNNkZA/formResponse";
      const formData = new FormData();
      formData.append("entry.329233376", name);
      formData.append("entry.882050184", email);
      formData.append("entry.981036613", message);
      ...
      try {
        ...
        showToast("Message could not be sent. Please email directly at albinjoy69@gmail.com");
      } finally {
